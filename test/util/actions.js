...
addBalancerLiquiditySafe = async (srcPoolObj, user) => {
    ...
    // const logString =  `addBalancerLiquidity() Pool: ${srcPoolObj.name} User: ${user.name}  Amount: ${amountLd.toString()}`
    // require('fs').writeSync(process.stdout.fd, `        ${logString} \n`);
    // console.log(
    ...
    // )
    await addBalancerLiquidity(srcPoolObj, user, amountLd)
}
...
actions = {
    addBalancerLiquidity: addBalancerLiquiditySafe,
